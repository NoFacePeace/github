...
func (n *NodeManager) checkNodes(ctx context.Context, cls *umov1.UmoCluster) error {
...
func (n *NodeManager) isClusterOffline(cls *umov1.UmoCluster) bool {
...
func (n *NodeManager) getUpdateStrategy(cls *umov1.UmoCluster) umov1.UpdateStrategy {
