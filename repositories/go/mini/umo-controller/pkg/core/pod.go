...
func (p *PodManager) GetClusterPods(ctx context.Context, cls *umov1.UmoCluster) ([]corev1.Pod, error) {
	list := &corev1.PodList{}
...
func (p *PodManager) CreatePod(ctx context.Context, cls *umov1.UmoCluster, pod *corev1.Pod) error {
