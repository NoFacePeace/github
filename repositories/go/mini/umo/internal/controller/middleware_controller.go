...
const (
	LabelMiddlewareType = "middleware-type"
)
...
// +kubebuilder:rbac:groups=umo.localhost,resources=middlewares,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=umo.localhost,resources=middlewares/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=umo.localhost,resources=middlewares/finalizers,verbs=update
