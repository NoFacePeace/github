...
type MiddlewareSpec struct {
	...
	// foo is an example field of Middleware. Edit middleware_types.go to remove/update
	// +optional
...
type MiddlewareStatus struct {
	...
	// conditions represent the current state of the Middleware resource.
...
type Middleware struct {
	...
	// spec defines the desired state of Middleware
	// +required
	Spec MiddlewareSpec `json:"spec"`

	// status defines the observed state of Middleware
	// +optional
	Status MiddlewareStatus `json:"status,omitempty,omitzero"`
}
